...
export default function PrivacyPolicyPage() {
  return (
    <PrivacyPolicyStyle>
      <title>애플리케이션 개인정보처리방침 - ijustwannaseewonwoo</title>
      <article>
        <h2>애플리케이션 개인정보처리방침</h2>

        <p>
          ijustwannaseewonwoo는 「개인정보 보호법」 제30조에 따라 정부주체의
          개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수
          있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.
        </p>

        <p>이 개인정보처리방침은 2021년 5월 24부터 적용됩니다.</p>

        <h3>제1조(개인정보의 처리 목적)</h3>

        <p>
          ijustwannaseewonwoo는 다음의 목적을 위하여 개인정보를 처리합니다.
        ...
        <p>
          justwannaseewonwoo는 법령에 따른 개인정보 보유·이용기간 또는
        ...
        <p>
          &lt;회원가입 및 관리&gt;와 관련한 개인정보는 수집.이용에 관한
          동의일로부터 탈퇴일까지 위 이용목적을 위하여 보유.이용됩니다.
        ...
        <ol>
          <li>
            정보주체는 ijustwannaseewonwoo에 대해 언제든지 개인정보
            열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
          </li>
          <li>
            제1항에 따른 권리 행사는ijustwannaseewonwoo에 대해 「개인정보
            보호법」 시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX)
            등을 통하여 하실 수 있으며 ijustwannaseewonwoo는 이에 대해 지체 없이
            조치하겠습니다.
          </li>
          <li>
          ...
          <li>
            ijustwannaseewonwoo는 정보주체 권리에 따른 열람의 요구, 정정·삭제의
        ...
        <p>ijustwannaseewonwoo는 다음의 개인정보 항목을 처리하고 있습니다.</p>
        <p>
          회원가입 및 관리
          <br />* 필수항목 : 이메일, 로그인ID, 서비스 이용 기록, 접속 로그, 쿠키
        </p>

        <h3>제5조(개인정보의 파기)</h3>
        <p>
          ijustwannaseewonwoo는 개인정보 보유기간의 경과, 처리목적 달성 등
        ...
        <ol>
          <li>
            파기절차
            <br />
            파기 사유가 발생한 개인정보를 선정하고, ijustwannaseewonwoo의
        ...
        <p>
          ijustwannaseewonwoo는 개인정보의 안전성 확보를 위해 다음과 같은 조치를
          취하고 있습니다.
        </p>
        ...
        <ol>
          ...
          <li>
            해킹 등에 대비한 기술적 대책
            <br />
            ijustwannaseewonwoo는 해킹이나 컴퓨터 바이러스 등에 의한 개인정보
        ...
        <p>
          ijustwannaseewonwoo는 이용자에게 개별적인 맞춤서비스를 제공하기 위해
        ...
        <p>
          ijustwannaseewonwoo는 개인정보 처리에 관한 업무를 총괄해서 책임지고,
        ...
        <p>
          ...
          <br />
          * 성명: 이경애
          <br />* 연락처: cindian@amazingbutuseless.net
        </p>
        <p>
          정보주체께서는 ijustwannaseewonwoo 의 서비스(또는 사업)을 이용하시면서
          발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한
          사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다.
          ijustwannaseewonwoo는 정보주체의 문의에 대해 지체 없이 답변 및
          처리해드릴 것입니다.
        </p>
        ...
        <p>
          ijustwannaseewonwoo는 정보주체의 개인정보 열람청구가 신속하게
          처리되도록 노력하겠습니다.
        </p>
        <p>
          * 개인정보 열람청구 접수·처리 부서
          <br />
          * 부서명: amazingbutuseless
          <br />
          * 담당자: 이경애
          <br />* 연락처: cindian@amaizngbutuseless.net
        </p>
