...
function SceneRegisteredVideoFeature() {
  return (
    <FeatureBoxStyle>
      ...
      <p>
        장면이 등록되면 플레이리스트 비디오 목록 속 섬네일 이미지 위에 고양이
        이모지가 표시됩니다.
        <br />
    ...
    <FeatureBoxStyle style={{ alignItems: "center" }}>
      ...
      <div style={{ padding: "2.4rem", paddingLeft: "0" }}>
        ...
        <p>
          ...
          <br />
          장면 외에 비디오 전체 또는 특정 부분을 재생하고 싶다면 유튜브에서
          비디오를 보던 것처럼 플레이어에서 재생 지점을 선택하거나, "장면 자동
          재생"을 비활성 시킬 수 있습니다.
        </p>
      </div>
    </FeatureBoxStyle>
  ...
  return (
    ...
    >
      <div style={{ marginTop: "auto", padding: "2.4rem 1.6rem" }}>
        <h3>장면 추가하기</h3>
        <p>
          장면이 등록되지 않은 비디오라면, 또는 내가 알고 있는 장면이 등록되지
          않은 경우라면 비디오에 장면을 추가할 수 있습니다.
        </p>
        <p>
          추가된 장면은 ijustwannaseewonwoo를 이용하는 다른 원우팬들에게
          비디오를 볼 수 있게 도와줄 뿐만 아니라, 장면 등록 과정 중 얼굴 데이터
          수집을 통해서 앞으로 많은 비디오에서 원우를 찾아내는데 도움을 주게
          됩니다.
        </p>
        <p>
          <strong>
